...
import (
	...
	app "github.com/theforceprotocolgroup/theforcechain"
)
...
func main() {
	...
	rootCmd := &cobra.Command{
		Use:               "theforcechaind",
		Short:             "theforcechain App Daemon (server)",
...
func newApp(logger log.Logger, db dbm.DB, traceStore io.Writer) abci.Application {
	return app.NewForceChainApp(logger, db)
}
...
func exportAppStateAndTMValidators(
	...
	if height != -1 {
		fcApp := app.NewForceChainApp(logger, db)
